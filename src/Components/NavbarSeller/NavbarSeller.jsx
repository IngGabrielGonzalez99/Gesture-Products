        ...
        <div className="container flex flex-wrap justify-between items-center mx-auto">
            ...
            <div className="hidden w-full md:block md:w-auto" id="navbar-default">
                <ul className="flex flex-col md:flex-row md:space-x-8 mt-4 md:mt-0">
                    <Link to="/InventoryManagmentSeller" className='block py-2 pr-4 pl-3 text-gray-700 rounded hover:bg-gray-100'>Gestión de inventario</Link>
                    <Link to="/SellProduct" className='block py-2 pr-4 pl-3 text-gray-700 rounded hover:bg-gray-100'>Generar Venta</Link>
